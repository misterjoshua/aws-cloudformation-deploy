...
## Simple Tags
* [`0`, `0.1`, `0.1.5` *(Dockerfile)*](https://github.com/misterjoshua/aws-cloudformation-deploy/blob/master/Dockerfile)
...
```
script:
  - pipe: docker://wheatstalk/aws-cloudformation-deploy:0.1.5
    variables:
